-- ============================================================================
-- Follow-up to 20260729100000: the same NOT-NULL-workspace_id bug also hit the
-- audit_logs insert at the end of import_leads_batch, so imports still failed
-- (just later in the function). Recreate the function with workspace_id set on
-- BOTH the leads insert and the audit_logs insert. Full definition below.
-- ============================================================================
