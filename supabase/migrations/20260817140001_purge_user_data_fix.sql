-- ============================================================================
-- 20260817140001_purge_user_data_fix.sql
-- Replaces the initial version (which used the superuser-only session_replication_role
-- that service_role can't set) with the privilege-safe multi-pass purge below.
