...
serve(async (req) => {
  ...
  try {
    ...
    for (const post of posts) {
      ...
      // Decrypt token columns in place before publishing.
      ...
      for (const target of targets) {
        ...
        // Roadmap 4.1: demo accounts hold a fake token — surface a clear message
        // rather than a confusing provider API error.
