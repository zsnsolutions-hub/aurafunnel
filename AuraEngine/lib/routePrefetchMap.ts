...
const routeImportMap: Record<string, () => Promise<unknown>> = {
  ...
  '/portal/business-settings': () => import('../pages/portal/BusinessSettingsPage'),
  '/portal/image-studio':   () => import('../pages/portal/ImageStudio'),
  ...
  '/portal/mobile':           () => import('../pages/portal/mobile/MobileHome'),
  '/portal/mobile/leads':     () => import('../pages/portal/mobile/MobileLeads'),
  '/portal/mobile/campaigns': () => import('../pages/portal/mobile/MobileCampaigns'),
  '/portal/mobile/activity':  () => import('../pages/portal/mobile/MobileActivity'),
  '/portal/mobile/more':      () => import('../pages/portal/mobile/MobileMore'),
  ...
  // Admin
  '/admin':          () => import('../pages/admin/console/AdminConsolePage'),
  ...
  '/admin/health':   () => import('../pages/admin/console/AdminConsolePage'),
