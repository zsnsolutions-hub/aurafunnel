...
const CommandPalette: React.FC<CommandPaletteProps> = ({ user, open, onClose }) => {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    { id: 'nav-team-boards', label: 'Team Flows', description: 'Kanban flow boards', category: 'navigation', icon: <TargetIcon className="w-4 h-4" />, action: () => navigate('/portal/team-hub') },
    ...
    { id: 'nav-billing', label: 'Subscription', description: 'Subscription management', category: 'navigation', icon: <CreditCardIcon className="w-4 h-4" />, action: () => navigate('/portal/billing') },
    { id: 'nav-invoices', label: 'Invoices', description: 'Manage invoices sent to clients', category: 'navigation', icon: <CreditCardIcon className="w-4 h-4" />, action: () => navigate('/portal/invoices') },
