          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24">
            <div className="md:col-span-5">
              ...
              <div className="flex space-x-4">
                <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-indigo-50 hover:border-indigo-100 transition-all duration-300 cursor-pointer text-slate-400 hover:text-indigo-600 font-bold hover:scale-110">𝕏</div>
                <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-indigo-50 hover:border-indigo-100 transition-all duration-300 cursor-pointer text-slate-400 hover:text-indigo-600 font-bold hover:scale-110">in</div>
              </div>
            </div>
